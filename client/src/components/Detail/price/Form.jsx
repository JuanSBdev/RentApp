   ...
   {lang === 'es' ? (
       ...
       <form  className=" border border-[#259073] flex flex-col items-center bg-[#fcffee] rounded shadow-lg p-5 mt-0  lg:flex-row " action="">
           ...
           <div className="m-1">
             ...
             <button onClick={submitForm} className="flex items-center justify-center h-12 px-6 w-64            bg-[#259073] mt-8 rounded font-bold text-sm text-white           hover:bg-[#7fda89] mx-2">Ver precios</button>
    ...
    <form  className=" border border-[#259073] flex flex-col items-center bg-[#fcffee] rounded shadow-lg p-5 mt-0  lg:flex-row " action="">
           ...
           <div className="m-1">
             ...
             <button onClick={submitForm} className="flex items-center justify-center h-12 px-6 w-64            bg-[#259073] mt-8 rounded font-bold text-sm text-white           hover:bg-[#7fda89] mx-2">Prices</button>
