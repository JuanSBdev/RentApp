...
export default function Capilla() {
  ...
  return (
    ...
    <div className="p-5">
        <a onClick={buscarEnCapilla}>
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Temporada Capilla Del Monte 2023</h5>
        </a>
        ...
        <button onClick={buscarEnCapilla}  className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Buscar
